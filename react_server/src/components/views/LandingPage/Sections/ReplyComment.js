import { CameraOutlined, GifOutlined, SmileOutlined, VideoCameraOutlined } from '@ant-design/icons'
...
function ReplyComment(props) {
    ...
    const [ThisPostCommentCount, setThisPostCommentCount] = useState(props.ThisPostCommentList.length)
    ...
    useEffect(() => {
        ...
        Axios.post('/api/like/getLikes', submitData)
            .then(response => {
    ...
    const RegisterComment = (e) => {
        ...
        var commentContent = document.getElementById(props.parentComment._id+"replyCommentSpan").innerText;
        ...
        if(window.event.keyCode ==  13){
                ...
                Axios.post('/api/comment/saveComment', submitData)
                .then(response => {
                    if(response.data.success){

                        alert("the Reply Comment registerd succesfully");
                ...
                document.getElementById(props.parentComment._id+"replyCommentSpan").innerText = "댓글을 등록하세요...";
        }
    }
