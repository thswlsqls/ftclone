  ...
  return (
    <div className="div_app">
      <div className="div_app_Split">
        ...
        <div className="div_appContainer" style={{ paddingTop: '75px', minHeight: 'calc(100vh - 80px)' }}>
          <Router>
            <Switch>
                ...
                <Route exact path="/workspace" component={Auth(WorkspacePage, true)} />
                <Route exact path="/templates" component={Auth(TemplateGalleryPage, true)}/>
